...
const GamePreview = (GamePreviewImageAndLinkProps: GamePreviewImageAndLinkProps) => {
  return (
    ...
    <div className="card max-w-96 shadow-xl text-black brightColor p-1">
  <figure>
  ...
  <div className="p-4">
    <h2 className="font-bold text-2x1">{GamePreviewImageAndLinkProps.GameName}</h2>
    <p className="font-normal text-xl">{GamePreviewImageAndLinkProps.GameDescription}</p>
